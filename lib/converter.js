...
const QUALITY_PRESETS = {
  accurate: { minAreaPercent: 0, maxShapes: 2500, precision: 5 },
  balanced: { minAreaPercent: 0.001, maxShapes: 700, precision: 4 },
  lightweight: { minAreaPercent: 0.003, maxShapes: 180, precision: 3 }
};
...
export function convertSvgToAlightXml(svgInput, rawOptions = {}) {
  ...
  return {
    ...
    profile: {
      version: '1.3.0',
      quality: options.quality,
      fidelityFirst: options.quality === 'accurate'
    },
    sourceFeatures
  };
}
